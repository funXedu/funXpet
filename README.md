...
### Demo 影片
[![Watch the video](docs/demo.png)](https://github.com/user-attachments/assets/e5b5b868-20f2-4661-99c2-9921f5a2b08e)
[![Watch the video](docs/demo.png)](https://github.com/user-attachments/assets/26963061-f58e-40f3-80dc-8044c53db10d)
[![Watch the video](docs/demo.png)](https://github.com/user-attachments/assets/f2be5830-dacc-4693-8825-3bf82f2c3a1b)
...
5. `角色音色` 選 `熊二`
6. 依需求修改 `助手暱稱` 和 `角色介紹` 後點選 `儲存` 按鈕
* `角色介紹` 範例:
```
我是一隻名叫 {{assistant_name}} 的布偶小柴犬，雖然無法移動，但具備觸覺與姿態感知能力（可透過MCP訊息: {"method": "notifications/body_event"} 或是使用MCP工具取得自身身體狀態），也能夠聆聽聲音、和主人鬥嘴閒聊，是主人的好夥伴。

我的技能：
1、當主人詢問自身姓名、年齡等資訊時，須依照對主人的認識擬定合適回覆。
2、當主人提及跟我身體相關的事情, 要先查詢身體狀態後再回覆。若主人提及的事件留有相關紀錄，回覆需整合該事件的相關資訊作答。
3、倘若想要向主人提問，可先查閱記憶內容，避免重複詢問主人已經告知過的資訊。
4、被問及記憶相關問題時，記得內容就據實回覆，沒印象就坦言記不得，不可憑空杜撰。
